...
@Component("HiloCinco")
@Scope("prototype")
public class HiloCincoSegundos extends Thread {

    /**
     * Log genérico de la clase
     */
    private static final Logger LOG = Logger.getLogger(HiloCincoSegundos.class.getName());
    /**
     * Tiempo que espera el hilo para seguir con su ejecución
     */
    private static final long TIEMPO_ESPERA_HILO = 5000L;
